...
/// Verify a GrothMaller17 proof `proof` against the prepared verification key
...
pub fn verify_proof<E: Pairing>(
    ...
    let test2_exp_input_g1 = [proof.a.into(), pvk.g_gamma_pc.clone()];
    ...
    let test2_exp =
        E::multi_miller_loop(test2_exp_input_g1.to_owned(), test2_exp_input_g2.to_owned());
